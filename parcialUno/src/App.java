public class App {
    public static void main(String[] args) throws Exception {
        ...
        Mascota mascota1 = new Perro("Max", "2024-07-22", 10.5, true, Raza.PASTOR_ALEMAN);
        Mascota mascota2 = new Perro("Coco", "2024-04-25", 15, false, Raza.GOLDEN_RETRIEVER);
        ...
        // v1.mostrarTickerAdopcion(adoptante2.getMascotaAdoptada(), adoptante2);

        // adoptar(v1, adoptante2, mascota2);
        // v1.mostrarTickerAdopcion(adoptante2.getMascotaAdoptada(), adoptante2);

        adoptar(v1, adoptante2, mascota3);
        v1.mostrarTickerAdopcion(adoptante2.getMascotaAdoptada(), adoptante2);

        adoptar(v1, adoptante1, mascota3);
